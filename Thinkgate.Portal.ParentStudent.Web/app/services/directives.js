(function() {
    ...
    app.directive('ccWidgetHeader', function() {
        ...
        var directive = {
            ...
            templateUrl: 'app/views/layout/widgetheader.html',
            restrict: 'A',
        };
        return directive;
    ...
    // this is for password validation, do not have a 'cstPassword' object value yet.
    app.directive('ccPassword', function () {
        return {
            restrict: 'A',
            require: 'ngModel',
