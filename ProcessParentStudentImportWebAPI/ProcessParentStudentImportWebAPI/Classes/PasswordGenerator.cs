namespace ProcessParentStudentImportWebAPI.Classes
{
    using System;
    ...
    public class PasswordGenerator
    {
        ...
        private const string pwdString = "abcdefghijklmnopqrstuvwxyzABCDEFG" +
                                   "HIJKLMNOPQRSTUVWXYZ0123456789`~!@#$%^&*()-_=+[]{}\\|;:'\",<" +
                                   ".>/?";
        private char[] pwdCharArray = pwdString.ToCharArray();
    }
